<header>
    ...
    <div class="navbar navbar-dark bg-dark box-shadow">
        <div class="container d-flex justify-content-between">
            <a href="#" class="navbar-brand d-flex align-items-center">
                ...
                <strong>Ifran E-commerce</strong>
            </a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-red">
        ...
        <div class="collapse navbar-collapse justify-content-center my_nav" id="navbarNav">
            <ul class="navbar-nav">
                @foreach ($categoryall as $category)
                <li class="nav-item">
                    <a class="nav-link" href=" {{route('Voir_categorie_produit', ["id" => $category->id])}} ">{{$category->nom}}</a>
                </li>
                @endforeach
